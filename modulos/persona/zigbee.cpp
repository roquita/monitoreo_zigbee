...
void zigbee_alerta_caida()
{
    ts_DstAddr sDstAddr;
    sDstAddr.u16DstAddr = ZIGBEE_DEST_ADDR;

    uint16_t caida_detectada = 1;
    zbhci_ZclSendReportCmd(0x02, sDstAddr, 1, 1, 0, 1, ZIGBEE_CLUSTER_ID, ZIGBEE_SENSOR_CAIDA_ID, ZCL_DATA_TYPE_DATA16, 2, (uint8_t *)&caida_detectada);
    delay(100);
